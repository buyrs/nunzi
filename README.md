...
<div align="center">
  ...
  <h1 align="center" style="border-bottom: none">Nunzi: The Autonomous Engineering Platform</h1>
  <p align="center">Powered by OpenHands Core</p>
</div>
...
🙌 Welcome to **Nunzi**, a next-generation Autonomous Engineering Platform built on the powerful [OpenHands](https://github.com/All-Hands-AI/OpenHands) core.

**Nunzi** extends the open-source OpenHands foundation with visionary capabilities like:
*   **🧠 Cortex:** Semantic Memory & Learning
*   **🛡️ Sentinel:** Autonomous CI/CD Repair
*   **🎨 Blueprint:** Whiteboard-to-Code
*   **🕹️ Studio Mode:** AI Engineering Lab
*   **🕸️ Swarm:** Multi-Agent Collaboration

See [features.md](features.md) for our detailed roadmap.

### About OpenHands (Legacy Core)

OpenHands (formerly the primary name of this repo) remains the open-source engine powering Nunzi. It provides the essential agent runtime, sandboxing, and LLM orchestration.

There are a few ways to work with OpenHands/Nunzi:
