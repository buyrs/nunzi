...
Thanks for your interest in contributing to Nunzi (powered by OpenHands)! We welcome and appreciate contributions.

## Understanding Nunzi's CodeBase
...
We have a separate doc [Development.md](https://github.com/buyrs/nunzi/blob/main/Development.md) that tells
...
1. **Download and use** OpenHands, and send [issues](https://github.com/buyrs/nunzi/issues) when you encounter something that isn't working or a feature that you'd like to see.
...
3. **Improve the Codebase** by sending [PRs](#sending-pull-requests-to-openhands) (see details below). In particular, we have some [good first issues](https://github.com/buyrs/nunzi/labels/good%20first%20issue) that may be ones to start on.
...
Our main agent is the CodeAct agent. You can [see its prompts here](https://github.com/buyrs/nunzi/tree/main/openhands/agenthub/codeact_agent).
...
by implementing the [interface specified here](https://github.com/buyrs/nunzi/blob/main/openhands/runtime/base.py).
...
You may also check out previous PRs in the [PR list](https://github.com/buyrs/nunzi/pulls).
...
If you notice any bugs or have any feature requests please open them via the [issues page](https://github.com/buyrs/nunzi/issues). We will triage
